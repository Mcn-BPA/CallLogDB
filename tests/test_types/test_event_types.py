...
from calllogdb.types.event import AnnounceEvent, HangupEvent, IvrEvent, GptEvent, QueueEvent, BlackListEvent, HTTPEvent, UnknownEvent, SpeechRecogEvent
...
def test_gpt_event_from_dict(mock_data):
    ...
    assert event.api_vars == {'account_id': '133429', 'num_a': '12396', 'num_b': '88002344499', 'call_id': '116-1741694432.6016962', 'num_c': 'null', 'short_num_found': 'false', 'vpbx_id': '16884', 'scenario_id': '34056', 'scenario_counter': '1', 'scenario_client_variables_1': 'short_num_found:false', 'scenario_id_1': '34056', 'dest_link_name': '', 'did': '12396', 'dtmf': '', 'ivr_object_id': '318', 'ivr_schema_id': '34056', 'linked_id': '116-1741694432.6016962', 'robocall_id': '0', 'robocall_target_number': '', 'robocall_task_contact_id': '0', 'robocall_task_id': '0', 'stt_answer': '', 'n8n_success': 'true'}
...
def test_blacklist_event_from_dict(mock_data):
    data = {
        "event_additional_info": {"exten": "1234"}
    }
...
def test_speech_recog_event_from_dict(mock_data):
    data = {
        "speechkit_dialog": [
            {"dialog_value": "What is the weather like?"},
            {"dialog_value": "It's sunny."}
        ]
    }
...
@pytest.mark.parametrize(
    ...
    [
        (GptEvent, {"event_additional_info": {"api_vars": "{account_id:133429,num_a:12396,num_b:88002344499,call_id:116-1741694432.6016962,num_c:null,short_num_found:false,vpbx_id:16884,scenario_id:34056,scenario_counter:1,scenario_client_variables_1:{short_num_found:false,vpbx_id:16884},scenario_id_1:34056,dest_link_name:,did:12396,dtmf:,ivr_object_id:318,ivr_schema_id:34056,linked_id:116-1741694432.6016962,robocall_id:0,robocall_target_number:,robocall_task_contact_id:0,robocall_task_id:0,stt_answer:,n8n_success:true}"}}, {'account_id': '133429', 'num_a': '12396', 'num_b': '88002344499', 'call_id': '116-1741694432.6016962', 'num_c': 'null', 'short_num_found': 'false', 'vpbx_id': '16884', 'scenario_id': '34056', 'scenario_counter': '1', 'scenario_client_variables_1': 'short_num_found:false', 'scenario_id_1': '34056', 'dest_link_name': '', 'did': '12396', 'dtmf': '', 'ivr_object_id': '318', 'ivr_schema_id': '34056', 'linked_id': '116-1741694432.6016962', 'robocall_id': '0', 'robocall_target_number': '', 'robocall_task_contact_id': '0', 'robocall_task_id': '0', 'stt_answer': '', 'n8n_success': 'true'}),
        (HTTPEvent, {"event_additional_info": {"api_vars": "{account_id:133429,num_a:12396,num_b:88002344499,call_id:116-1741694432.6016962,num_c:null,short_num_found:false,vpbx_id:16884,scenario_id:34056,scenario_counter:1,scenario_client_variables_1:{short_num_found:false,vpbx_id:16884},scenario_id_1:34056,dest_link_name:,did:12396,dtmf:,ivr_object_id:318,ivr_schema_id:34056,linked_id:116-1741694432.6016962,robocall_id:0,robocall_target_number:,robocall_task_contact_id:0,robocall_task_id:0,stt_answer:,n8n_success:true}"}}, {'account_id': '133429', 'num_a': '12396', 'num_b': '88002344499', 'call_id': '116-1741694432.6016962', 'num_c': 'null', 'short_num_found': 'false', 'vpbx_id': '16884', 'scenario_id': '34056', 'scenario_counter': '1', 'scenario_client_variables_1': 'short_num_found:false', 'scenario_id_1': '34056', 'dest_link_name': '', 'did': '12396', 'dtmf': '', 'ivr_object_id': '318', 'ivr_schema_id': '34056', 'linked_id': '116-1741694432.6016962', 'robocall_id': '0', 'robocall_target_number': '', 'robocall_task_contact_id': '0', 'robocall_task_id': '0', 'stt_answer': '', 'n8n_success': 'true'}),
    ]
)
